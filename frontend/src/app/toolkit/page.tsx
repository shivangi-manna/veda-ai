  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 px-4 py-8">
      ...
      <div className="bg-white border border-[#eaeaea] rounded-2xl p-12 shadow-sm text-center space-y-4">
        ...
        <h2 className="text-lg font-bold text-[#181818]">AI Teacher's Toolkit</h2>
        <p className="text-xs text-gray-500 max-w-sm mx-auto leading-relaxed">
          Access AI helpers, curriculum planners, and class grading resources. This feature is coming soon to your VedaAI workspace.
        </p>
      </div>
    </div>
  );
